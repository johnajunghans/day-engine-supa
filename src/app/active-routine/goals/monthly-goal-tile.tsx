                    ...
                    <ListItem key={action.id} ml="0.5rem">
                        <Box id={`action-${action.id}-container`} display="grid" gridTemplateColumns="1fr 1fr" ml="0.5rem" _hover={{bgColor: "rgba(255,255,255,0.25)"}} transition="100ms" borderRadius="5px" p="3px" pos="relative">
                            ...
                            <Flex pos="absolute" right="5px" top="calc(50% - 12px)">
                                <IconButton aria-label="delete-action" size="xs"  _hover={{bgColor: "rgba(255,255,255,0.25)"}}  width="24px" height="24px" bgColor="unset" icon={<EditIcon boxSize={3} color="white" />} />
                                <IconButton aria-label="delete-action" size="xs"  _hover={{bgColor: "rgba(255,255,255,0.25)"}} width="24px" height="24px" bgColor="unset" icon={<DeleteIcon boxSize={3} color="white" />} />
                            </Flex>  
                        </Box>
                    </ListItem>
                ))}
